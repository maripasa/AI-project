...
clean-unix:
	rm -f obj/PGM_Operations.o obj/SCM_Util.o bin/SCM_Extractor bin/SCM_Extractor.exe
clean-windows:
	del obj/PGM_Operations.o obj/SCM_Util.o bin/SCM_Extractor bin/SCM_Extractor.exe
